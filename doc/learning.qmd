...
user_1_info_data <- import_user_info(user_1_info_file)
```
...
Go back to what has been done for user info and create a function around it to be used for all the users.
...
import_user_info(user_1_info_file)
```
...
import_saliva_data(user_1_saliva_file)
```
